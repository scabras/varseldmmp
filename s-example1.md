...
---------------------------------------------------
    ...
    ## Of these, 1200 are sampled with replacement
    ## Then, 1100 are kept and used to construct the summaries
    ## Working on the problem...please wait.

    res.conventional$inclprob[res.conventional$inclprob>0.5]

    ##   ARGF_at   YOAB_at   YXLE_at 
    ## 0.5672727 0.9509091 0.9209091
...
![](s-example1_files/figure-markdown_strict/unnamed-chunk-15-1.svg)
    ...
    ## CARB_at.1 YOAB_at.1 YXLD_at.1 
    ## 0.5605836 0.9990099 0.6848181
...
![](s-example1_files/figure-markdown_strict/unnamed-chunk-17-1.svg)
    ...
    ## DNAJ_at.1 YOAB_at.1 YRHE_at.1 YXLE_at.1 
    ## 0.5447155 0.9895253 0.5586710 0.8198246
